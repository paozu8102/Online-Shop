...
public class forgotpasswordController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String service = request.getParameter("service");
        AccountDBcontext ud = new AccountDBcontext();
        if (service != null) {
            if (service.equalsIgnoreCase("submitEmail")) {
                try {
                    String emailAddress = request.getParameter("email");
                    Account user = ud.findUserByEmail(emailAddress);
                    if (user == null) {
                        ...
                        request.setAttribute("milis", milis);
                        request.setAttribute("mess", "Send Mail Successfully!Check your mail!!!!");
