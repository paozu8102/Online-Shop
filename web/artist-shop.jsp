    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active dropdown"><a class="nav-link dropdown-toggle"
                                                        href="#" id="dropdown04" data-toggle="dropdown"
                                                        aria-haspopup="true"
                                                        aria-expanded="false">Shop</a>
                    <div class="dropdown-menu" aria-labelledby="dropdown04">
                        <a class="dropdown-item" href="shop">Shop</a> <a class="dropdown-item"
                                                                         href="wishlist.jsp">Wishlist</a> <a
                            class="dropdown-item"
                            href="product-single.jsp">Single
                ...
                <c:if test="${sessionScope.acc==null}">
                    <li class="nav-item active"><a href="login" class="nav-link">Sign
                        In</a></li>
                </c:if>
                <c:if test="${sessionScope.acc!=null}">
                    <li><a class="getstarted scrollto" href="logout"></a></li>
                    <li class="nav-item active"><a href="UserProfile"
                                                   class="nav-link">Profile</a></li>
                    <li class="nav-item active"><a href="logout" class="nav-link">Sign
                        Out</a></li>
                </c:if>


                <li class="nav-item cta cta-colored"><a href="cart" class="nav-link"><span
                        class="icon-shopping_cart"></span>[${cartlist.size()}]</a></li>
                            ...
                            <fieldset class="filter-price">
                                ...
                                <div class="price-field">
                                    <input type="range" min="0" max="100"
                                           value="${param.discountmin == null ? 0: param.discountmin}"
                                           id="lower-discount">
                                    <input type="range" min="0" max="100"
                                           value="${param.discountmax == null ? 100: param.discountmax}"
                                           id="upper-discount">
                                </div>
                                <div class="price-wrap">
                                    ...
                                    <div class="price-container">
                                        <div class="price-wrap-1">
                                            ...
                                            <input value="${param.discountmin}" name="discountmin"
                                                   id="one-discount">
                                        </div>
                                        <div class="price-wrap_line">-</div>
                                        <div class="price-wrap-2">
                                            <label for="two-discount">%</label>
                                            <input value="${param.discountmax}" name="discountmax"
                                                   id="two-discount">
                                ...
                                <div class="price-wrap">
                                    ...
                                    <div class="price-container">
                                        <div class="price-wrap-1">
                                            ...
                                            <input value="${param.minwidth}" name="minwidth"
                                                   id="minWidth">
                                        ...
                                        <div class="price-wrap-2">
                                            ...
                                            <input value="${param.maxwidth}" name="maxwidth"
                                                   id="maxWidth">
                            ...
                            <div class="price-wrap">
                                ...
                                <div class="price-container">
                                    <div class="price-wrap-1">
                                        ...
                                        <input value="${param.minheight}" name="minheight"
                                               id="minHeight">
                                    </div>
                                    <div class="price-wrap_line">-</div>
                                    <div class="price-wrap-2">

                                        <input value="${param.maxheight}" name="maxheight"
                                               id="maxHeight">
                                        <label for="two">cm</label>
                                    </div>
                                </div>
