                ...
                <div class="page-breadcrumb bg-white">
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12" style="width: 100%">
                            <h4 class="page-title" style="width: 100%">Post Management / ${action eq 'update' ? 'Update' : 'Add'} Post</h4>
                        </div>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                        ...
                        <div class="col-sm-12">
                            <div class="white-box">
                                ...
                                <div class="table-responsive">
                                    <form action="crudpost">
                                        <table class="table text-nowrap">
                                            <tbody>
                                                <tr>
                                                    <td class="border-top-0">Post ID</td>
                                                    <td>
                                                        ${post.getPostID()}
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input style="width: 100%; border: none; color: #3e5569" required type="text" value="${post.getTitle()}" name="title">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="border-top-0">Content</td>
                                                    <td class="url" style="max-width: 500px; overflow: auto">
                                                        <input style="width: 100%; border: none; color: #3e5569" required type="text" value="${post.getContent()}" name="content">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="border-top-0">Date</td>
                                                    <td>
                                                        <input style="width: 100%; border: none; color: #3e5569" readonly required type="date" value="${post.getDate().split(" ")[0]}" name="content">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="border-top-0">UserName</td>
                                                    <td>${post.getUserID()}</td>
                                                </tr>
                                                <tr>
                                                    <td class="border-top-0">Status</td>
                                                    <td>
                                                        <select name="statusid" style="width: 100%; border: none; color: #3e5569"   >
                                                            <option value="1" ${post.getStatusID() eq 'Waiting'? 'selected' : ''}>Waiting</option>
                                                            <option value="2" ${post.getStatusID() eq 'Approved'? 'selected' : ''}>Approved</option>
                                                            <option value="3" ${post.getStatusID() eq 'Denied'? 'selected' : ''}>Denied</option>
                                                        </select>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="border-top-0">Post Type</td>
                                                    <td>
                                                        <input style="width: 100%; border: none; color: #3e5569" required type="text" pattern="[0-9]+" title="not valid" value="${post.getPostType()}" name="posttype">
                                                    </td>
                                                </tr>
                                                <tr>
