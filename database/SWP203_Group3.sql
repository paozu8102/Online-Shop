...
VALUES ('Beautiful Painting', 100.00,	'A stunning painting that brings freshness and brightness with vibrant colors and exquisite details. It reflects artistic talent and meticulous investment in every brushstroke, providing a sense of comfort and relaxation when looked upon',	50.0,	45.0,	1,	0,	0,	2, 1),
	   ...
	   ('Red Sunset', 292.00,	'Painting is an art form of painting on a surface by aesthetically applying colored fluids. Painters represent a very personal expression on supports such as paper, rock, canvas, wood, bark, glass, concrete and many other substrates. Work of representation or invention, painting can be naturalistic and figurative, or abstract. It can have narrative, descriptive, symbolic, spiritual, or philosophical content.',	30,	20,	1,	0,	0,	2, 1),
	   ('INFINITÉ', 132.00,	'A little composition game around the golden ratio and the Fibonacci sequence, and the opportunity to test pastel painting on tissue paper.',	29,	21,	1,	0,	0,	2, 1),
	   ('Ocean Sunset', 499.00,	'A vibrant sunset painting with pastels to brighten up any décor!',	24,	18,	1,	0,	0,	2, 1),
	   ('Still life Pastel Print', 123.00,	'Original pastel painting on paper. Best choice for your interior. This art work brings luck to its owner.',	30,	20,	1,	0,	0,	2, 1),
	   ('COLONIAL style HOUSE', 254.00,	'the size of the sheet with fields for Passepartout: 32 x 24 cm. The size of the drawing itself: approx. 27 x 20 cm',	32,	24,	1,	0,	0,	3, 1),
	    ('Peaceful Street',150.00,	'A "Peaceful Street" painting captures a serene and tranquil urban or suburban scene, inviting viewers into a world of calm and harmony.',	47,	31,	1,	0,	0,	7, 1),
		('Summer Noon', 150.00,	'A "Summer Noon" painting captures the essence of a bright and vibrant midday scene during the summer season.',	47,	31,	1,	0,	0,	7, 1),
		('Spring Sunlight', 160.00,	'A "Spring Sunlight" painting captures the enchanting and rejuvenating qualities of sunlight in the early days of the spring season.',	47,	31,	1,	0,	0,	7, 1),
		('Camellia', 67.00,	'"Camellia" is a captivating artwork that captures the essence of beauty, delicacy, and grace. The painting focal point is a stunning camellia flower, rendered with meticulous detail at the center of the canvas. The camellia petals are a rich, velvety shade of pink, their soft curves and layers depicted with great precision.',	19,	19,	1,	0,	0,	2, 1),
        ('Lotus Lady VIII', 170.00,	'"Lotus Lady VIII" is a captivating and symbolic artwork that features a woman in a serene and contemplative pose amidst a backdrop of lotus flowers.',	29,	37,	1,	0,	0,	3, 1),
		 ('Lotus Lady VI', 170.00,	'"Lotus Lady VI" is a captivating and symbolic artwork that features a woman in a serene and contemplative pose amidst a backdrop of lotus flowers.',	29,	37,	1,	0,	0,	9, 1),
		 ('Lotus Lady IV', 170.00,	'"Lotus Lady IV" is a captivating and symbolic artwork that features a woman in a serene and contemplative pose amidst a backdrop of lotus flowers.',	29,	37,	1,	0,	0,	9, 1),
		 ('Fairy Tail II', 170.00,	'If "Fairy Tail II" is a painting featuring a girl showering, it would typically fall under the category of figurative or contemporary art. The artist approach to the subject matter would greatly influence the style and tone of the painting, whether it focuses on realism, abstraction, symbolism, or other artistic techniques.',	24,	31,	1,	0,	0,	9, 1),
		 ('The Faces', 67.00,	'"The Faces" is a series of captivating abstract artworks that explore the human face as a source of inspiration and expression. In each piece, the artist deconstructs and reimagines facial features in a unique and non-traditional manner, pushing the boundaries of conventional representation.',	43,	39,	1,	0,	0,	9, 1),
		  ('Abstract 10', 97.00,	'"Abstract 10" is a captivating abstract artwork that engages viewers with its expressive use of color, shape, and form. The artist employs a bold and dynamic approach, creating a composition that is both visually stimulating and emotionally evocative.',	49,	31,	1,	0,	0,	9, 1),
		  ('Such a Kiss', 86.00,	'"This Painting is a vibrant and passionate work of art that captures the essence of a kiss through abstract forms and expressive use of color. The canvas comes alive with a fusion of bold reds, pinks, and purples, creating an atmosphere of intensity and warmth. ',	39,	31,	1,	0,	0,	9, 1),
		  ('Couple at night', 175.00,	'This evocative artwork captures a serene and intimate moment between two individuals under the enchanting veil of the night sky. The painting is suffused with a deep, velvety darkness that serves as the backdrop for the protagonists of the scene.',	40,	20,	1,	0,	0,	9, 1),
		  ('Night seascape', 134.00,	'This mesmerizing painting transports viewers to the tranquil and enchanting world of the nighttime seascape. The canvas is a vast expanse of deep, velvety blues and purples, representing the dark, calm waters of the sea.',	40,	27,	1,	0,	0,	9, 1),
		  ('Toad folk painting', 56.00,	'This enchanting painting is a celebration of folk art and the quirky world of toads. The canvas bursts with vibrant colors, intricate patterns, and a sense of joyful storytelling. The toads, anthropomorphized and full of character, take center stage in this whimsical composition.',	40,	30,	1,	0,	0,	2, 1),
		   ('SPRING IN THE AIR', 677.00,	'Spring in the air I adore spring with its warm wind, lots of sun and hope it brings.',	73,	100,	1,	0,	0,	3, 1);
